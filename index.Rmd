...
When running the spatial imputation function (impute.fun) you may see some warnings. These arise for geographic units that have no contiguous neighbors (e.g., islands, national parks, naval facilities) or whose neighbors all have missing values. In those cases the function correctly leaves their values as NA, and these units are handled explicitly in the subsequent step (by exclusion or by borrowing from a higher-level geography). These warnings are expected and do not indicate a problem with the imputation.
...
ReADI_CBG_2022 <- ReADI_CBG_2022_Imp %>%
  dplyr::mutate(ReADI_CBG_2022_Imp,
    MEDFI = B19013_001,
...
ReADI_CT_2022 <- ReADI_CT_2022_Imp %>%
  dplyr::mutate(ReADI_CT_2022_Imp,
    MEDFI = B19013_001,
    INCDIS = log(100*((B19001_002 + B19001_003 + B19001_004 + 1)/(B19001_014 + B19001_015 + B19001_016 + B19001_017 + 1))),
    BELPL = B17017_002/B17017_001*100,
    PL150 = (C17002_005 + C17002_004 + C17002_003 + C17002_002)/C17002_001*100,
